"""
Tests for Money Floor-Divisions
"""
...
class TestMoneyFloorDivision:

    def test_floor_division_of_money_by_money_default(self):
    ...
    def test_floor_division_of_money_by_numeric_default(self):
        money = Money(3, "EUR") // 2
    ...
    def test_working_floor_divisions_money_by_money(self):
    ...
    def test_working_floor_divisions_money_by_numeric(self):
        money = Money(20, "BGN") // 6
        assert money.amount == 3.0
        money = Money(50, "EUR") // 7
        assert money.amount == 7.0
        money = Money(225, "GBP") // 35
        assert money.amount == 6.0
        money = Money(30_200, "TRY") // 30
        assert money.amount == 1006.0

    def test_money_by_money_floor_divisions_with_currency_mismatch(self):
